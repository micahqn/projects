...
worlds = {
    ...
    "lord" : ["You are generating me a game, and you are making the player play a game where they are a lord of a small village. The player will have to manage their village and make decisions that will affect the villagers. Begin by asking for the person's name, and remember it", "You are generating a game, create detailed scenarios and multiple choice questions for the player, The player will have to manage their village and make decisions that will affect the villagers. Make sure to make plot and link them together in a sensible way. Also give short questions with descriptive words to describe the current setting. Do not make the player roll a die, you decide the outcome based off previous situations."]
}
