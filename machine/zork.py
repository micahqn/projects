...
while True:
    ...
    match choice:
        case "y":
            with open("machine//zork_context.txt", "r") as f:
                if f.read() == None: continue
                _ = chat.send_message(message=[f.readlines()])
                input()
                break
